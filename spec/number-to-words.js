...
describe('toWords', () => {
  const tests = [
    ...
    { input: 1_000_000_000_000_000, expect: 'one quadrillion' },
    {
        input: 5_555_555_555_555_555,
  ...
  function addTest(test) {
    it(`should pass, if ${formatNumber(test.input)} returns ${test.expect}`, () => {
      expect(new NumberToWords(test.input).convert()).to.equal(test.expect);
    });
  }
